...
def get_total_CN(cov_file):
    ...
    av_3a5_cov = float(all_reg[3][3])/(float(all_reg[3][2]) - float(all_reg[3][1]))
    ...
    av_3a4_cov = float(all_reg[8][3])/(float(all_reg[8][2]) - float(all_reg[8][1]))
    ...
    av_ctrl_reg = float(all_reg[11][3])/(float(all_reg[11][2]) - float(all_reg[11][1]))
